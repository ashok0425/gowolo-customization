...
@php
    // Index existing answers by question_key for prefill
...
<div class="card">
    <div class="card-header"><h4 class="card-title">Edit Request Details</h4></div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.requests.update', $customizationRequest) }}">
            @csrf @method('PUT')

            <h6 class="section-heading mb-3 mt-2 font-weight-bold">Customer Information</h6>
            <div class="row">
                <div class="col-md-6">
            ...
            <h6 class="section-heading mb-3 mt-4 font-weight-bold">Community Information</h6>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <h6 class="section-heading mb-3 mt-4 font-weight-bold">Requirements</h6>
            <div class="row">
                @foreach([
                    'req_logo'           => 'Logo',
                    'req_icon'           => 'Web Icon',
            ...
            {{-- ============== Additional Information (Questionary) ============== --}}
            <h6 class="section-heading mb-3 mt-4 font-weight-bold">Additional Information</h6>
            ...
            <div class="d-flex justify-content-between mt-3">
                <a href="{{ route('admin.requests.show', $customizationRequest) }}" class="btn btn-secondary">Cancel</a>
