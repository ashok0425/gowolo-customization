                                        ...
                                        <div class="dropdown-title" style="display: flex;flex-direction:column;">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="avatar-sm ">
                                                    ...
                                                    <img src="${profile_pic}" alt="" class="avatar-img rounded-circle" style="width:150% !important; height:100% !important;"  onerror="this.src='${error}'">
                                                </div>
                                            <div calss="">
                               ...
                               /* div += `<li>
									...
									*/
									...
									div += `<li>
										...
										<img src="${uprofile_pic}" alt="${postuname}" onerror="this.src='${error}'" text="${uprofile_pic}">
										<div class="text">
												<h4>${postuname}</h4>
