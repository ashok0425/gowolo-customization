                        ...
                        if(data.data.length == 0){
                            ...
                            $.each(data.data,function(i,value){
                                ...
                                if(value.unreadnotifys.module == announce_config){
									...
									if(value.unreadnotifys.user_id==948){
									routeUrl = APP_URL+"/support/customization-chat?cust_req_id="+value.unreadnotifys.module_id;	
									}
									else{
                                    routeUrl = APP_URL+"/customization/customize-user-chat?cust_req_id="+value.unreadnotifys.module_id;
									} 
